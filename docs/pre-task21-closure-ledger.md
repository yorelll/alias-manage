...
| CLI reload/doctor/transfer persistence | CI-verifiable | CLI integration tests | CLI sync includes retired Shell names; preview is read-only and confirmed import persistence is covered by fast CI `32011753420`; durable doctor findings remain incomplete; integration `32010337861` passed |
