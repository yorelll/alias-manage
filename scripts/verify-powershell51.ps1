...
# Name validation is covered by unit tests (aliasmgr-core validation.rs).
Record-Result "PS51-008" "ACL/target protection alias name validation" "EXPECTED-LIMITATION" `
    ...
    "unit-tested via aliasmgr-core; PS5.1 native-stderr EAP interaction defers live check to manual" `
    "validation.rs"
