...
|---|---|---|---|
| GUI npm cache | implementation-feasible | lockfile + pinned GUI CI cache | `crates/aliasmgr-gui/ui/package-lock.json` committed and CI now uses `npm ci`/npm cache; verification pending for commit `5239a2e` |
